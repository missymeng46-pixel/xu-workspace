...
一个运行在自己电脑上的个人工作空间，把任务计划、项目、内容、Vibe Coding 发现、财务、运动打卡、收件箱和每日总结小票放在同一处。
...
- 项目：待开始、进行中、待确认看板
- 内容：灵感池、制作中、待发布、已发布
- Vibe 雷达：聚合全球当天与最近 7 天的新项目、文章和开发者讨论，可筛选并收进内容灵感池
...
Vibe 雷达进入页面时按需加载，不会拖慢工作台首页。当前聚合 GitHub Search、Hacker News Algolia 和 Google News RSS 三个公开来源，不需要额外 API Key。
